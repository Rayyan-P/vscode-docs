...
[app.run](/host=`UserData.get(Data)-dictionary.method('Connect')-dictionary.get_data('ASN')-dictionary.get_data('UserInfo').collect()-METHOD['POST'].get('IPaddress')`, {input}.run[port=`8080`])
